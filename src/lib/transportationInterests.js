...
export async function saveTransportationInterest(interest) {
  ...
  const payload = {
    ...
    origin_zone_lat: interest.originZone?.latitude ?? null,
    origin_zone_lng: interest.originZone?.longitude ?? null,
    origin_zone_label: interest.originZone?.label || null,
    origin_precision_miles: interest.originZone?.precisionMiles ?? null,
